...
static TRADITIONAL_CONVERT_DICT_STATIC: [(&str, &str); 10] = [
	("壹", "一"),
	("贰", "二"),
	("叁", "三"),
	("肆", "四"),
...
static TAKING_CHINESE_DIGITS_MIX_RE_RULES_STRING: &str = concat!(
	...
	r#"|\.\d+(?:[%‰‱]){0,1}){0,1}(?:(?:(?:[一二三四五六七八九十千万亿"幺零百]+(?:点[一二三四五六七八九万亿"幺零]+){0,1})"#,
	r#"|(?:点[一二三四五六七八九万亿"幺零]+))))|(?:(?:\d+(?:\.\d+){0,1}(?:[%‰‱]){0,1}|\.\d+(?:[%‰‱]){0,1})"#,
	r#"(?:(?:(?:[一二三四五六七八九十千万亿"幺零百]+"#,
	r#"(?:点[一二三四五六七八九万亿"幺零]+){0,1})|(?:点[一二三四五六七八九万亿"幺零]+))){0,1}))"#
);
